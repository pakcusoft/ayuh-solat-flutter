...
class AppLocalization {
  ...
  String get notifications =>
      locale.languageCode == 'en' ? 'Notifications' : 'Pemberitahuan';
  ...
  String get adzanSound =>
      locale.languageCode == 'en' ? 'Adzan Sound' : 'Bunyi Azan';
  ...
  String get prayerTimeZone =>
      locale.languageCode == 'en' ? 'Prayer Time Zone' : 'Zon Waktu Solat';
  String get selectZone =>
      locale.languageCode == 'en' ? 'Select Zone' : 'Pilih Zon';
  ...
  String zoneSaved(String zone) =>
      locale.languageCode == 'en' ? 'Zone saved: $zone' : 'Zon disimpan: $zone';
  String get currentZone =>
      locale.languageCode == 'en' ? 'Current Zone' : 'Zon Semasa';

  // Prayer Schedule
  String get prayerSchedule =>
      locale.languageCode == 'en' ? 'Prayer Schedule' : 'Jadual Solat';
  ...
  String get systemDiagnostics =>
      locale.languageCode == 'en' ? 'System Diagnostics' : 'Diagnostik Sistem';

  String get testingTips =>
      locale.languageCode == 'en' ? 'Testing Tips' : 'Tips Ujian';
  ...
  String get testPrayerTime =>
      locale.languageCode == 'en' ? 'Test Prayer Time' : 'Uji Waktu Solat';
  ...
  String get qiblaDirection =>
      locale.languageCode == 'en' ? 'Qibla Direction' : 'Arah Kiblat';
  ...
  String get unknown =>
      locale.languageCode == 'en' ? 'Unknown' : 'Tidak Diketahui';
  ...
  String get loading =>
      locale.languageCode == 'en' ? 'Loading...' : 'Memuatkan...';
  String get refresh => locale.languageCode == 'en' ? 'Refresh' : 'Muat Semula';
  String get nextPrayer =>
      locale.languageCode == 'en' ? 'Next Prayer' : 'Solat Seterusnya';
  String get timeRemaining =>
      locale.languageCode == 'en' ? 'Time Remaining' : 'Masa Berbaki';

  // Notification messages
  String get prayerReminder =>
      locale.languageCode == 'en' ? 'Prayer Reminder' : 'Peringatan Solat';
  String prayerReminderBody(String prayer) => locale.languageCode == 'en'
      ? 'Time for $prayer prayer in 10 minutes'
      : 'Waktu $prayer dalam 10 minit';
  String get prayerTime =>
      locale.languageCode == 'en' ? 'Prayer Time' : 'Waktu Solat';
  ...
  String error(String error) =>
      locale.languageCode == 'en' ? 'Error: $error' : 'Ralat: $error';
  ...
  String get testNotification =>
      locale.languageCode == 'en' ? 'Test Notification' : 'Pemberitahuan Ujian';
  ...
  String prayerReminderBodyWithTime(String prayer, String time) =>
      locale.languageCode == 'en'
      ? '$prayer prayer in 10 minutes at $time'
      : 'Waktu $prayer lagi 10 minit pada $time';
  ...
  String getLocalizedPrayerName(String englishPrayerName) {
    switch (englishPrayerName.toLowerCase()) {
      ...
      case 'isha':
        return isha;
      default:
        return englishPrayerName;
    }
  }

  // Status labels
  String get currentPrayer =>
      locale.languageCode == 'en' ? 'CURRENT' : 'SEMASA';

  // Error messages for prayer times screen
  String get tryAgain =>
      locale.languageCode == 'en' ? 'Try Again' : 'Cuba Lagi';
  ...
  String get openSettings =>
      locale.languageCode == 'en' ? 'Open Settings' : 'Buka Tetapan';
  ...
  String get prayerCompleted =>
      locale.languageCode == 'en' ? 'Prayer completed' : 'Solat selesai';

  String get dateInformation =>
      locale.languageCode == 'en' ? 'Date Information' : 'Maklumat Tarikh';

  String get gregorian =>
      locale.languageCode == 'en' ? 'Gregorian' : 'Gregorian';

  String get hijri => locale.languageCode == 'en' ? 'Hijri' : 'Hijri';

  String get currentTime =>
      locale.languageCode == 'en' ? 'Current Time' : 'Masa Semasa';

  String get active => locale.languageCode == 'en' ? 'ACTIVE' : 'AKTIF';

  String get ended => locale.languageCode == 'en' ? 'ENDED' : 'BERAKHIR';

  String get upcoming =>
      locale.languageCode == 'en' ? 'UPCOMING' : 'AKAN DATANG';

  // Offline mode
  String get offlineMode =>
      locale.languageCode == 'en' ? 'Offline Mode' : 'Mod Luar Talian';

  // Zone search functionality
  String get searchZones =>
      locale.languageCode == 'en' ? 'Search zones...' : 'Cari zon...';
  ...
  String get noZonesFound =>
      locale.languageCode == 'en' ? 'No zones found' : 'Tiada zon dijumpai';
  ...
  static const List<Locale> supportedLocales = [Locale('ms'), Locale('en')];
}
